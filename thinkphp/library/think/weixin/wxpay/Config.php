...
class Config extends ConfigInterface{
    ...
    public function __construct($config){
        ...
        if (isset($config['cert_pem'])) {
            $this->cert['cert_pem']=$config['cert_pem'];
        }
        if (isset($config['key_pem'])) {
            $this->cert['key_pem']=$config['key_pem'];
        }
    }
	//=======【基本信息设置】=====================================
	/**
	...
	**/
	 ...
	 * {@inheritDoc}
	 * @see WxPayConfigInterface::GetSignType()
	 */
	...
	public function GetSSLCertPath(&$sslCertPath, &$sslKeyPath){
		$sslCertPath = $_SERVER['DOCUMENT_ROOT'].'/cert/apiclient_cert.pem';
		$sslKeyPath = $_SERVER['DOCUMENT_ROOT'].'/cert/apiclient_key.pem';
	}
}
